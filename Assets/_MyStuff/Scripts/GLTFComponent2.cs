...
namespace UnityGLTF
{
	...
	/// </summary>
	public class GLTFComponent2 : MonoBehaviour
	{
		...
		public async Task Load()
		{
			...
			{
				//Debug.Log("Reached GLTF Finally");
				if(loader != null)
				{
					...
					DoOnLoad.Invoke();
					Debug.Log("Invoked actions?");

					var scaler = GetComponent<MeshScaler>();

					//if (scaler != null)
     //               {
					//	Debug.Log("gltf Scaler found");
					//	try
					//	{
					//		scaler.ScaleMesh();
					//		scaler.SnapMeshToFloor();
					//	}
					//	catch { }
					//	var controller = GameObject.FindGameObjectWithTag("GameController");
					//	controller.GetComponent<AndroidTest>().text.text = "GLTF Loaded?";
					//	//Debug.Log("GLTF Loaded?");
					//}
				}
			}
		}
